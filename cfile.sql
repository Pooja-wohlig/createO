...
--
-- Host: localhost
-- Generation Time: Jan 18, 2016 at 05:43 AM
...
--
-- Table structure for table `cfile_fileupload`
--

CREATE TABLE `cfile_fileupload` (
  `id` int(11) NOT NULL,
  `cdate` date NOT NULL,
...
--
-- Dumping data for table `cfile_fileupload`
--

INSERT INTO `cfile_fileupload` (`id`, `cdate`, `currenttime`, `image`) VALUES
(3, '0000-00-00', '0000-00-00 00:00:00', 'pdf12.pdf'),
(4, '0000-00-00', '0000-00-00 00:00:00', 'pdf13.pdf');
...
(5, 'File Uplod', '', '', 'site/viewfileupload', 1, 0, 1, 2, 'icon-dashboard'),
...
--
-- Indexes for table `cfile_fileupload`
--
ALTER TABLE `cfile_fileupload`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `cfile_fileupload`
--
ALTER TABLE `cfile_fileupload`
