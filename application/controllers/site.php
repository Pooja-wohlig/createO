...
$access=array("1");
$this->checkaccess($access);
$data["page"]="viewfileupload";
$data["base_url"]=site_url("site/viewfileuploadjson");
$data["title"]="View fileupload";
$this->load->view("template",$data);
}
function viewfileuploadjson()
{
$elements=array();
$elements[0]=new stdClass();
...
$elements[3]=new stdClass();
$elements[3]->field="`cfile_fileupload`.`image`";
$elements[3]->sort="1";
...
$access=array("1");
$this->checkaccess($access);
$data["page"]="createfileupload";
$data["title"]="Create fileupload";
$this->load->view("template",$data);
}
public function createfileuploadsubmit()
{
$access=array("1");
$this->checkaccess($access);
$this->form_validation->set_rules("cdate","cdate","trim");
$this->form_validation->set_rules("currenttime","currenttime","trim");
if($this->form_validation->run()==FALSE)
{
$data["alerterror"]=validation_errors();
$data["page"]="createfileupload";
...
$currenttime=$this->input->get_post("currenttime");
...
echo $image;
if($this->fileupload_model->create($cdate,$image,$currenttime)==0)
$data["alerterror"]="New fileupload could not be created.";
else
$data["alertsuccess"]="fileupload created Successfully.";
 $data["redirect"]="site/viewfileupload";
$this->load->view("redirect",$data);
}
}
...
$access=array("1");
$this->checkaccess($access);
$data["page"]="editfileupload";
$data["title"]="Edit fileupload";
$data["before"]=$this->fileupload_model->beforeedit($this->input->get("id"));
$this->load->view("template",$data);
}
public function editfileuploadsubmit()
{
$access=array("1");
$this->checkaccess($access);
...
$cdate=$this->input->get_post("cdate");
$currenttime=$this->input->get_post("currenttime");
if($this->fileupload_model->edit($id,$cdate,$currenttime)==0)
$data["alerterror"]="New fileupload could not be Updated.";
else
$data["alertsuccess"]="fileupload Updated Successfully.";
$data["redirect"]="site/viewfileupload";
$this->load->view("redirect",$data);
}
}
...
$access=array("1");
$this->checkaccess($access);
$this->fileupload_model->delete($this->input->get("id"));
$data["redirect"]="site/viewfileupload";
$this->load->view("redirect",$data);
}
